...
public class GetUserRequest extends ClickUpRequest {
	...
	public GetUserRequest(String accessToken, String teamID, Long userID) {
		super(accessToken);
	...
	public CUMemberResponse execute() {
		HTTPRequest httpRequest = new HTTPRequest("https://api.clickup.com/api/v2/team/" + getTeamID() + "/user/" + getUserID(), RequestMethod.GET);
