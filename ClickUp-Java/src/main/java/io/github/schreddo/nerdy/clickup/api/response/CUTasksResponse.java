...
public class CUTasksResponse extends ClickUpResponse {

	public CUTasksResponse(int responseCode, String json) {
		super(responseCode, json);
	}

	@Override
	public ArrayList<CUTask> obj() {
		Gson gson = new Gson();
		
		return gson.fromJson(getJson(), BaseCollection.class).getTasks();
	}
