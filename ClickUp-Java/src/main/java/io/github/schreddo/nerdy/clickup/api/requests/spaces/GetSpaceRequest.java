...
public class GetSpaceRequest {
	...
	public GetSpaceRequest(String accessToken, Long spaceID) {
		setAccessToken(accessToken);
		setSpaceID(spaceID);
	}
	
	public ClickUpResponse<CUSpace> execute() {
		HTTPRequest httpRequest = new HTTPRequest("https://api.clickup.com/api/v2/space/" + getSpaceID(), RequestMethod.GET);
