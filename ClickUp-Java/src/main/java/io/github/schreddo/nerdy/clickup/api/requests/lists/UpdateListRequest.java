...
public class UpdateListRequest {
	...
	public UpdateListRequest(String accessToken, String listID, CUList list) {
	...
	public ClickUpResponse<CUList> execute() {
		Gson gson = new Gson();
		HTTPRequest httpRequest = new HTTPRequest("https://api.clickup.com/api/v2/list/" + getListID(), RequestMethod.PUT);
