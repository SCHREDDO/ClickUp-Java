...
public class GetFolderlessListsRequest {
	...
	public GetFolderlessListsRequest(String accessToken, Long spaceID, Boolean archived) {
	...
	public ClickUpResponse<BaseCollection> execute() {
		HTTPRequest httpRequest = new HTTPRequest("https://api.clickup.com/api/v2/space/" + getSpaceID() + "/list", RequestMethod.GET);
