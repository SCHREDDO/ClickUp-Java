...
public class CreateListRequest {
	...
	public CreateListRequest(String accessToken, Long folderID, CUList list) {
	...
	public ClickUpResponse<CUList> execute() {
		Gson gson = new Gson();
		HTTPRequest httpRequest = new HTTPRequest("https://api.clickup.com/api/v2/folder/" + getFolderID() + "/list", RequestMethod.POST);
