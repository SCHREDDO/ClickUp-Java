...
public class CUFPriorities extends BaseCUFeatuer {
	@SerializedName("priorities")
	private ArrayList<CUPriority> priorities;
	
	public ArrayList<CUPriority> getPriorities() {
		return priorities;
	}
	public void setPriorities(ArrayList<CUPriority> priorities) {
		this.priorities = priorities;
	}
	
	public CUFPriorities() {
