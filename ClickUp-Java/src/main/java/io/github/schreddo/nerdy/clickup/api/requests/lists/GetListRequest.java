...
public class GetListRequest {
	...
	public void setSpaceID(Long listID) {
		this.listID = listID;
	}
	
	public GetListRequest(String accessToken, Long listID) {
		setAccessToken(accessToken);
		setSpaceID(listID);
	}
	
	public ClickUpResponse<CUList> execute() {
		HTTPRequest httpRequest = new HTTPRequest("https://api.clickup.com/api/v2/list/" + getSpaceID(), RequestMethod.GET);
