...
public class DeleteFolderRequest {
	...
	public DeleteFolderRequest(String accessToken, Long folderID) {
		setAccessToken(accessToken);
		setFolderID(folderID);
	}
	
	public ClickUpResponse<Object> execute() {
		HTTPRequest httpRequest = new HTTPRequest("https://api.clickup.com/api/v2/folder/" + getFolderID(), RequestMethod.DELETE);
