...
public class GetFolderRequest {
	...
	public GetFolderRequest(String accessToken, Long folderID) {
		setAccessToken(accessToken);
		setFolderID(folderID);
	}
	
	public ClickUpResponse<CUFolder> execute() {
		HTTPRequest httpRequest = new HTTPRequest("https://api.clickup.com/api/v2/folder/" + getFolderID(), RequestMethod.GET);
