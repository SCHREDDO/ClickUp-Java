...
public class UpdateSpaceRequest {
	...
	public UpdateSpaceRequest(String accessToken, Long spaceID, CUSpace space) {
	...
	public ClickUpResponse<CUSpace> execute() {
		Gson gson = new Gson();
		HTTPRequest httpRequest = new HTTPRequest("https://api.clickup.com/api/v2/space/" + getSpaceID(), RequestMethod.PUT);
