...
public class CreateFolderRequest {
	...
	public CreateFolderRequest(String accessToken, Long spaceID, CUFolder folder) {
	...
	public ClickUpResponse<CUFolder> execute() {
		Gson gson = new Gson();
		HTTPRequest httpRequest = new HTTPRequest("https://api.clickup.com/api/v2/space/" + getSpaceID() + "/folder", RequestMethod.POST);
