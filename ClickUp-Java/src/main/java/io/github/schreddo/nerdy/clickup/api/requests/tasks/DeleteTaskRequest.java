...
public class DeleteTaskRequest {
	...
	public DeleteTaskRequest(String accessToken, String taskID) {
		setAccessToken(accessToken);
		setTaskID(taskID);
	}
	
	public ClickUpResponse<Object> execute() {
		HTTPRequest httpRequest = new HTTPRequest("https://api.clickup.com/api/v2/task/" + getTaskID(), RequestMethod.DELETE);
